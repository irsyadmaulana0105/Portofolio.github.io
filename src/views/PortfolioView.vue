            ...
            <div v-for="item in items" :key="item.id">
              <div class="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-amber-50 md:gap-3 px-5 py-5 lg:px-5">
                <div class="flex h-12 w-12 items-center justify-center p-0 h-full w-full lg:p-0 zoom-in">
                  <img alt="project image" loading="lazy" decoding="async" class="drop-shadow-xl rounded rounded-xl"
                    :src="'/img/' + item.imageFileName">
                </div>
      ...
      items: [
        {
          id: 1,
          name: 'Pecos',
          imageFileName: 'portofolio-pweb.png',
          status: 'Aplikasi pesanan kopi berbasis website yang bisa digunakan untuk pesanan dicafe.',
          tech: 'Node JS, PHP, Tensorflow',
          // github: 'https://github.com/irsyadmaulana0105/CritterShield',
          // demo: 'https://bagasrakha.netlify.app/'
        },
        {
          id: 2,
          name: 'CritterShield',
          imageFileName: 'portofolio-hama.png',
          status: 'Aplikasi sistem pendeteksi hama dan penyakit pada tanaman padi berbasis website menggunakan metode machine learning dan CNN',
          tech: 'HTML, CSS',
          github: 'https://github.com/irsyadmaulana0105/CritterShield',
        ...
        },
        {
          id: 3,
          name: 'Wonderful',
          imageFileName: 'portofolio-wonderful.png',
          status: 'Cloning app Wonderful indonesia',
          tech: 'CSS, HTML, JS',
          github: 'https://github.com/irsyadmaulana0105/wonderful',
          demo: 'null'
        },
        // {
        //   id: 4,
        //   name: 'Bumdesma',
        //   imageFileName: 'bumdesma.png',
