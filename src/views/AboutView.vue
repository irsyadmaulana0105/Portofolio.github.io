  ...
  <div
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center max-w-sm"> <!-- Atur lebar maksimum div -->
        <img class="w-6/12 rounded-full mb-3 fadein-up" src="@/assets/ul.jpg" alt="Foto" width="200" height="200">
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Halo semuanya! Nama saya M Irsyad Maulana. Saya seorang Junior Programmer web dari Fakultas Ilmu Komputer Universitas Jember.
             Saya memiliki pengalaman cukup dalam pengembangan web back-end. Saya sangat menikmati apa yang saya lakukan saat ini, 
             menurut saya membuat program bukan sekedar pekerjaan, tapi juga sebuah seni yang mempunyai nilai estetika.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; Tugas saya sebagai mahasiswa adalah mengerjakan tugas dan situs web agar berfungsi dan ramah pengguna namun tetap menarik.
            Selain itu, 
            Tujuan saya adalah menyampaikan pesan dan identitas Anda dengan cara yang paling kreatif. Jika Anda tertarik untuk mempekerjakan saya.
          </p>
        </div>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-200 bg-amber-200 bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Bahasa</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-amber-200 bg-amber-200 bg-opacity-10': activeTab === 2 }" @click="activeTab = 2">Tambahan</button>
            </li>
          </ul>
        </div>
